...
public class AdminController implements Initializable {
    ...
    * Aggiorna l'etichetta del pulsante, aggiorna la configurazione globale tramite AppConfig
    * e salva la scelta in modo persistente per l'applicazione.
    * Mostra un alert di conferma dopo l'impostazione.
    */
    private void chooseStopwordsIT() {
        ...
        if (file != null) {
            ...
            AppConfig.setStopwordsPathIT(file.getAbsolutePath());
            showAlert("File stopwords IT impostato!");
        }
    }
    ...
    */
    private void chooseStopwordsEN() {
        ...
        if (file != null) {
            ...
            AppConfig.setStopwordsPathEN(file.getAbsolutePath());
            showAlert("File stopwords EN impostato!");
        }
    }
